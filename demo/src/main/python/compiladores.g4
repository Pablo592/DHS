...
bloquefor: FOR PARENTESISABRE  (VARIABLE IGUAL (VARIABLE|NUMERO)) PUNTOYCOMA (VARIABLE (IGUAL|MAYOR|MENOR) (VARIABLE|NUMERO)) PUNTOYCOMA ((VARIABLE (SUMAUNO | RESTAUNO)) | ((SUMAUNO | RESTAUNO) VARIABLE) | (VARIABLE (MASIGUAL | MENOSIGUAL) (VARIABLE|NUMERO))) PARENTESISCIERRA instruccion;
